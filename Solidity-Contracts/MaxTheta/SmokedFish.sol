...
contract SmokedFish is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    string private baseURI;

    uint256 public MAX_NFT_SUPPLY = 69;
    ...
    constructor(address fee, string memory uri) ERC721("Smoked Fish", "SF") {
        creatorAddress = fee;
        baseURI = uri;
    ...
    * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        return 777000000000000000000; // 1 - 69 777 TFUEL
    }
    ...
    */
    function safeMint(address to) public payable {
        ...
        uint256 ownerPayout = (msg.value / 100) * 25;
