...
contract UnshakeableVideo is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor(address fee, string memory uri) ERC721("Unshakeable' - Timelapse Video", "U-TV") {
        creatorAddress = fee;
        baseURI = uri;
    }
    ...
    */
    function reserveNFTS(uint256 numberOfNfts, address _senderAddress) public onlyOwner {
        require(totalSupply() + numberOfNfts <= MAX_NFT_SUPPLY, "Not enough NFTs left");
