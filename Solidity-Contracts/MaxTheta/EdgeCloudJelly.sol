...
contract EdgeCloudJelly is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    string private baseURI;

    uint256 public MAX_NFT_SUPPLY = 54;


    constructor(string memory uri) ERC721("Edge Cloud Jelly", "ECJ") {
        baseURI = uri;
    }
