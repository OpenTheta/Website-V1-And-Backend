...
contract SkullyFishPrint is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    string private baseURI;

    uint256 public MAX_NFT_SUPPLY = 5;


    constructor(string memory uri) ERC721("Skully Fish Print", "SFP") {
        baseURI = uri;
    }
