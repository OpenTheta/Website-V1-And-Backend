...
contract SPSPopMagsStreamingEventRace is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor(string memory uri) ERC721("SPS Pop & Mags Streaming Event Race", "SPS-Pop&Mags") {
        baseURI = uri;
    }
