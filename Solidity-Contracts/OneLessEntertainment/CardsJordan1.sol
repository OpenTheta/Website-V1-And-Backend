...
contract TrophyRoomxAirJordan1 is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    string private baseURI;

    uint256 public MAX_NFT_SUPPLY = 200;

    bool public saleIsActive = false;

    address public feeAddress;

    constructor(address fee, string memory uri) ERC721("Trophy Room x Air Jordan 1", "TRxAJ1") {
        feeAddress = fee;
        baseURI = uri;
    }
    ...
    * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        return 200000000000000000000; // 1 - 200 200 TFUEL
    }
