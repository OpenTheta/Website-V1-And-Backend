...
// Token starting at 1
contract GimmeTheTFuel is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    string private baseURI;

    uint256 public MAX_NFT_SUPPLY = 310;
    ...
    address private musicCreatorAddress = 0xdF2a4D5c1783dC8d27902DaA00A52076B875d11e;


    constructor(address fee, string memory uri) ERC721("Gimme the TFuel", "GTT") {
        feeAddress = fee;
        baseURI = uri;
    }
 ...
 * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        return 250000000000000000000; // 1 - 310 250 TFUEL
    }
    ...
    */
    function safeMint(address to) public payable {
        ...
        uint256 musicCreatorPayout = (msg.value / 100) * 40;
