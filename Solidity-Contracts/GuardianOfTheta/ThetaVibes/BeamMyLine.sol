...
// Token starting at 1
contract BeamMyLine is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    string private baseURI;

    uint256 public MAX_NFT_SUPPLY = 160;
    ...
    constructor(address fee, string memory uri) ERC721("Beam My Line", "BML") {
        feeAddress = fee;
        baseURI = uri;
    }
 ...
 * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        return 600000000000000000000; // 1 - 160 600 TFUEL
    }
