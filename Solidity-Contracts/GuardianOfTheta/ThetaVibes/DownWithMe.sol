...
// Token starting at 1
contract DownWithMe is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    string private baseURI;

    uint256 public MAX_NFT_SUPPLY = 250;
    ...
    constructor(address fee, string memory uri) ERC721("Down with Me", "DWM") {
        feeAddress = fee;
        baseURI = uri;
    }
 ...
 * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        return 400000000000000000000; // 1 - 250 400 TFUEL
    }
    ...
    */
    function safeMint(address to) public payable {
        ...
        uint256 ownerPayout = msg.value - feePayout - imageCreatorPayout;
