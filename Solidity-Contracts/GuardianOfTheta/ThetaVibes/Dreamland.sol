...
// Token starting at 1
contract Dreamland is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    string private baseURI;

    uint256 public MAX_NFT_SUPPLY = 60;
    ...
    constructor(address fee, string memory uri) ERC721("Dreamland", "DREAM") {
        feeAddress = fee;
        baseURI = uri;
    }
 ...
 * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        return 650000000000000000000; // 1 - 60 650 TFUEL
    }
