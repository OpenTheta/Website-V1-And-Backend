...
contract ThetaConPunkCity is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    string private baseURI;

    uint256 public MAX_NFT_SUPPLY = 36;


    constructor(string memory uri) ERC721("ThetaCon Punk City", "TCPC") {
        baseURI = uri;
    }
