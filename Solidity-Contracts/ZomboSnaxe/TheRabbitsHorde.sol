...
contract TheRabbitsHorde is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    bool public mintingIsActive = false;
    uint public MAX_NFT_SUPPLY = 6999;

    //    mapping Address to access to mint
    mapping(address => bool) private AddressIsMinter;

    constructor() ERC721("The Rabbit's Horde", "TRH") {
    }
    ...
    * Change fee address
    */
    function changeMaxSupply(uint maxSupply) public onlyOwner {
