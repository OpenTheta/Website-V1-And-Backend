...
contract ProxyMinter  is Ownable {
    address public mintingContract = 0x7d4f100C2614EDF83c4338fA4947b789808Ab8ab;

    uint private MAX_NFT_SUPPLY = 111;
    uint public totalSupply = 0;
    uint public PRICE = 480000000000000000000;
    address public feeAddress;
    address public creatorAddress;

    uint16[111] private order;
    uint private start;
    uint private end;
    uint private stepSize = 111;
