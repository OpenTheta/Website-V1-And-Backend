...
contract ThetaPugs is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor(address fee, string memory uri) ERC721("ThetaPugs", "PUG") {
        feeAddress = fee;
        baseURI = uri;
    }
 ...
 * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 7500) {
            return 600000000000000000000; // 7500 - 10000 600 TFUEL
        } else if (currentSupply >= 5000) {
            return 400000000000000000000; // 5000 - 7499 400 TFUEL
        } else if (currentSupply >= 2500) {
            return 250000000000000000000; // 2500 - 4999 250 TFUEL
        } else if (currentSupply >= 1000) {
            return 150000000000000000000; // 1000 - 2499 150 TFUEL
        } else if (currentSupply >= 500) {
            return 100000000000000000000; // 500 - 999 100 TFUEL
        } else if (currentSupply >= 100) {
            return 75000000000000000000; // 100 - 499 75 TFUEL
        } else {
            return 50000000000000000000; // 0 - 99 50 TFUEL
        }
    }

    /**
    * Set some ThetaPugs aside
    */
    function reserveNFTS(uint256 numberOfNfts, address _senderAddress) public onlyOwner {
        ...
        for (uint i = 0; i < numberOfNfts; i++) {
            ...
            if (totalSupply() < MAX_NFT_SUPPLY )
            {
                ...
                _setTokenURI(supply, string(abi.encodePacked(baseURI, id, ".json")));
            }
        }
    }
