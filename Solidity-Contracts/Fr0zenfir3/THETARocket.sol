...
contract ThetaRocket is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    string private baseURI;

    uint256 public MAX_NFT_SUPPLY = 246;


    constructor(string memory uri) ERC721("THETA Rocket", "TR") {
        baseURI = uri;
    }
    ...
    */
    function reserveToAddresses(address[] memory _senderAddress) public onlyOwner {
        require(totalSupply() + _senderAddress.length < MAX_NFT_SUPPLY);
