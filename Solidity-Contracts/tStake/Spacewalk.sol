...
// Token starting at 1
contract ThetaManSpacewalk is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor(address fee, string memory uri) ERC721("ThetaManSpacewalk", "TMSA-01") {
        feeAddress = fee;
        baseURI = uri;
    }
