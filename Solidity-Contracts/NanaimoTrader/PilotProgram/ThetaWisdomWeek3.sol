...
// Token starting at 1
contract ThetaWisdomWeek3 is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor(address creator, string memory uri) ERC721("Theta Wisdom Week 3", "TW-W3") {
 ...
 * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        return 88000000000000000000; // 1 - n 88 TFUEL
    }
    ...
    */
    function changeCreatorAddress(address newAddress) public onlyOwner {
        require(creatorAddress == msg.sender, 'Only current creatorAddress can change it');
