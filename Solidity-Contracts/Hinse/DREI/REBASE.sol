...
contract REBASE is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    string private URI;

    uint256 public MAX_NFT_SUPPLY = 1;

    bool public saleIsActive = false;

    address public feeAddress;

    constructor(address fee, string memory uri) ERC721("REBASE", "REBASE") {
        feeAddress = fee;
        URI = uri;
    }
    ...
    * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        return 4999000000000000000000; // 1 4999 TFUEL
    }
