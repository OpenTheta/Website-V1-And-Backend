...
contract ThetaBulls is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor(address fee, string memory uri) ERC721("ThetaBulls", "TB") {
        feeAddress = fee;
        baseURI = uri;
    }
 ...
 * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 7500) {
            return 500000000000000000000; // 7500 - 9999 500 TFUEL
        } else if (currentSupply >= 5000) {
            return 400000000000000000000; // 5000 - 7499 400 TFUEL
        } else {
            return 300000000000000000000; // 0 - 1999 300 TFUEL
        }
    }
    ...
    */
    function safeMint(address to) public payable {
        ...
        uint256 ownerPayout = (msg.value / 1000) * 925;
