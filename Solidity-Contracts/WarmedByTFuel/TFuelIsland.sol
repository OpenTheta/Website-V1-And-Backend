...
// Token starting at 1
contract TNT21 is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    string private baseURI;

    uint256 public MAX_NFT_SUPPLY = 130;

    constructor(string memory uri) ERC721("Warmed by TFuel - Tdrop Cove on Tfuel Island", "WBT-TCTI") {
        baseURI = uri;
    }
