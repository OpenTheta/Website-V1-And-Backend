...
contract VixensKittens is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor(address fee, string memory uri) ERC721("Vixens Kittens", "VK") {
        feeAddress = fee;
        baseURI = uri;
    }
    ...
    * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        return 200000000000000000000; // 1 - 555 200 TFUEL
    }
