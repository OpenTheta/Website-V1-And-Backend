...
contract ThetaPonsS1 is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    string private baseURI;

    uint256 public MAX_NFT_SUPPLY = 2560;
    ...
    constructor(address fee, string memory uri) ERC721("ThetaPons S1", "TS-S1") {
        creatorAddress = fee;
        baseURI = uri;
    ...
    * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        return 59000000000000000000; // 1 - 2560 59 TFUEL
    }
    ...
    */
    function safeMint(address to) public payable {
        ...
        uint256 ownerPayout = (msg.value / 100) * 40;
