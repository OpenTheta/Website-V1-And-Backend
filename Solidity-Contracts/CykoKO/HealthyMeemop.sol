...
contract HealthyMeemop is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    string private baseURI;

    uint256 public MAX_NFT_SUPPLY = 73;


    constructor(string memory uri) ERC721("Healthy Meemop", "HM") {
        baseURI = uri;
    }
