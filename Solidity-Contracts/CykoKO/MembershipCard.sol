...
contract MeepyMembershipCard is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    string private baseURI;

    uint256 public MAX_NFT_SUPPLY = 80;


    constructor(string memory uri) ERC721("Meepy Membership Card", "MMC") {
        baseURI = uri;
    }
