...
contract J13Y1 is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor(address fee, string memory uri) ERC721("Node Master: J13 Y1", "NM-J") {
        feeAddress = fee;
        baseURI = uri;
    }
    ...
    * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        return 150000000000000000000; // 1 - 60 150 TFUEL
    }
