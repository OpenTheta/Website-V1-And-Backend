...
contract ThetaCargoShip is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor(address fee, string memory uri) ERC721("Theta Cargo Ship", "TCS") {
        feeAddress = fee;
        baseURI = uri;
    }
    ...
    * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        return 75000000000000000000; // 1 - 100 75 TFUEL
    }
