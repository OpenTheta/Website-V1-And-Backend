...
contract M1TCH is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    string private baseURI;

    uint256 public MAX_NFT_SUPPLY = 40;

    bool public saleIsActive = false;

    address public feeAddress;

    constructor(address fee, string memory uri) ERC721("Node Master: M1TCH", "NM-M") {
        feeAddress = fee;
        baseURI = uri;
    }
    ...
    * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        return 225000000000000000000; // 1 - 40 225 TFUEL
    }
