...
// Token starting at 1
contract MysticGurusPromo2021 is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor(address fee, string memory uri) ERC721("MysticGurusPromo2021", "MG") {
        feeAddress = fee;
        baseURI = uri;
    }
 ...
 * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        return 300000000000000000000; // 1 - 555 300 TFUEL
    }
