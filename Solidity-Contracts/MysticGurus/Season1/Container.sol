...
contract ContainerNFT is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    uint public mintedAmount = 0;
    uint256 public MAX_NFT_SUPPLY = 5111;
    string private baseURI;
    uint16[5111] private order;
    uint private start;
    uint private end;
    ...
    constructor(address fee, string memory _uri, uint _startTokenId) ERC721("ContainerNFT", "C-NFT") {
        baseURI = _uri;
        feeAddress = fee;
    ...
    * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        return 1000000000000000000000; // 1 - 5111 1000 TFUEL
    }
