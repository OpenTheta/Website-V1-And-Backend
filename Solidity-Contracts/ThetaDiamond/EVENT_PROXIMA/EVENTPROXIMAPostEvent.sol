...
contract EVENTPROXIMAPostEvent is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    string private baseURI;

    uint256 public MAX_NFT_SUPPLY = 111;

    constructor(string memory uri) ERC721("EVENT PROXIMA Post Event", "EVPE") {
        baseURI = uri;
    }
    ...
    */
    function reserveToAddresses(uint256 numberOfNfts, address[] memory _senderAddress) public onlyOwner {
        require(totalSupply() < MAX_NFT_SUPPLY, "All already Minted");
