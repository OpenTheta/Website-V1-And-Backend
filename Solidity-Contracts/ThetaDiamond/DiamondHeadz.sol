...
contract DiamondHeadz is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    uint public Price = 888000000000000000000;

    address public DailyDiamond = 0x66E93C5eBEF7eBCc2FdF1b9a0dA2b32E9a8730d2;
    ...
    constructor(address fee, string memory uri) ERC721("DiamondHeadz", "DH") {
        feeAddress = fee;
        baseURI = uri;
    ...
    */
    ...
    function getDiscountedNFTPrice(address buyer) public view returns (uint256) {
        require(totalSupply() < MAX_NFT_SUPPLY, "Sale has already ended");
        if(IERC721(DailyDiamond).balanceOf(buyer)>0) {
            return Price*85/100;
        } else {
            return Price;
        }
    ...
    function hasDiscount(address buyer) public view returns(bool) {
        return (IERC721(DailyDiamond).balanceOf(buyer) > 0);
    }
    ...
    */
    function safeMint(address to) public payable {
        ...
        uint256 ownerPayout = (msg.value / 100) * 65;
