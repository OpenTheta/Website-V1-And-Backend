...
// File: contracts/AstroBuilderz/Wall.sol
...
contract AstroBuilderz_Wall is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    string private baseURI;
    address public minterAddress;
    uint256 public MAX_NFT_SUPPLY = 999;

    constructor(string memory _baseURI, address minter) ERC721("AstroBuilderz Wall", "AB-Wall") {
        baseURI = _baseURI;
        minterAddress = minter;
    }

    function mint(address to, uint256 tokenId) public {
        require(msg.sender == minterAddress, "Only Minter allowed");
