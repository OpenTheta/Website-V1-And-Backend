...
contract TFuelDreams is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor(address fee, string memory uri) ERC721("TFuelDreams", "TFD") {
        feeAddress = fee;
        baseURI = uri;
    }
 ...
 * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        return 100000000000000000000; // 0 - 249 100 TFUEL
