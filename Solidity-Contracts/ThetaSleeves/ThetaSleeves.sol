...
contract ThetaSleeves is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor(address fee, string memory uri) ERC721("Theta Sleeves", "TS") {
        creatorAddress = fee;
        baseURI = uri;
    ...
    * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        return 222000000000000000000; // 1 - 5555 222 TFUEL
    }
