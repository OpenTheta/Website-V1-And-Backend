...
contract NewYearsZilla is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor(address fee, string memory uri) ERC721("NewYearsZilla", "NYZ") {
        feeAddress = fee;
        baseURI = uri;
    }
    ...
    */
    function safeMint(address to) public payable {
        ...
        uint256 ownerPayout = (msg.value / 100);
