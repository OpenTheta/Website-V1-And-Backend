...
contract PixZilla is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor(address fee, string memory uri) ERC721("PixZilla", "PZ") {
        feeAddress = fee;
        baseURI = uri;
    }
 ...
 * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 8000) {
            return 100000000000000000000; // 8000 - 9999 100 TFUEL
        } else if (currentSupply >= 7500) {
            return 95000000000000000000; // 7500 - 7999 95 TFUEL
        } else if (currentSupply >= 7000) {
            return 90000000000000000000; // 7000 - 7499 90 TFUEL
        } else if (currentSupply >= 6500) {
            return 85000000000000000000; // 6500 - 6999 85 TFUEL
        } else if (currentSupply >= 6000) {
            return 80000000000000000000; // 6000 - 6499 80 TFUEL
        } else if (currentSupply >= 5500) {
            return 75000000000000000000; // 5500 - 5999 75 TFUEL
        } else if (currentSupply >= 5000) {
            return 70000000000000000000; // 5000 - 5499 70 TFUEL
        } else if (currentSupply >= 4500) {
            return 65000000000000000000; // 4500 - 4999 65 TFUEL
        } else if (currentSupply >= 4000) {
            return 60000000000000000000; // 4000 - 4499 60 TFUEL
        } else if (currentSupply >= 3500) {
            return 55000000000000000000; // 3500 - 3999 55 TFUEL
        } else if (currentSupply >= 3000) {
            return 50000000000000000000; // 3000 - 3499 50 TFUEL
        } else if (currentSupply >= 2500) {
            return 45000000000000000000; // 2500 - 2999 45 TFUEL
        } else if (currentSupply >= 2000) {
            return 40000000000000000000; // 2000 - 2499 40 TFUEL
        } else if (currentSupply >= 1500) {
            return 35000000000000000000; // 1500 - 1999 35 TFUEL
        } else if (currentSupply >= 1000) {
            return 30000000000000000000; // 1000 - 1499 30 TFUEL
        } else if (currentSupply >= 500) {
            return 25000000000000000000; // 500 - 999 25 TFUEL
        } else {
            return 20000000000000000000; // 0 - 499 20 TFUEL
        }
    }
    ...
    */
    function safeMint(address to) public payable {
        ...
        uint256 ownerPayout = (msg.value / 100) * 88;
