...
// Token starting at 1
contract ThetaTeeth is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    string private baseURI;

    uint256 public MAX_NFT_SUPPLY = 3232;

    bool public saleIsActive = false;

    address public feeAddress;

    constructor(address fee, string memory uri) ERC721("ThetaTeeth", "TT") {
        feeAddress = fee;
        baseURI = uri;
    }
 ...
 * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 2350) {
            return 400000000000000000000; // 2351 - 3232 400 TFUEL
        } else if (currentSupply >= 1600) {
            return 350000000000000000000; // 1601 - 2350 350 TFUEL
        } else if (currentSupply >= 1000) {
            return 300000000000000000000; // 1001 - 1600 300 TFUEL
        } else if (currentSupply >= 500) {
            return 250000000000000000000; // 501 - 1000 250 TFUEL
        } else {
            return 200000000000000000000; // 1 - 500 200 TFUEL
        }
    }
