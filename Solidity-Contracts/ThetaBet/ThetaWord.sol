...
// Token starting at 1
contract ThetaWord is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {

    string private baseURI;

    uint256 public MAX_NFT_SUPPLY = 610;

    bool public saleIsActive = false;

    address public feeAddress;

    constructor(address fee, string memory uri) ERC721("ThetaWord", "TW") {
        feeAddress = fee;
        baseURI = uri;
    }
 ...
 * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        return 222000000000000000000; // 1 - 610 222 TFUEL
    }
