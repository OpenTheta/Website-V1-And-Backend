...
interface IERC721Receiver {
    /**
     * @dev Whenever an {IERC721} `tokenId` token is transferred to this contract via {IERC721-safeTransferFrom}// SPDX-License-Identifier: MIT
...
contract ThetaZilla is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    constructor(address fee, string memory uri) ERC721("ThetaZilla", "TZ") {
        feeAddress = fee;
        baseURI = uri;
    }
 ...
 * @dev Gets current Price
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 6000) {
            return 175000000000000000000; // 6000 - 9999 200 TFUEL
        } else if (currentSupply >= 2000) {
            return 125000000000000000000; // 2000 - 5999 150 TFUEL
        } else {
            return 75000000000000000000; // 0 - 1999 100 TFUEL
        }
    }
    ...
    */
    function safeMint(address to) public payable {
        ...
        uint256 ownerPayout = (msg.value / 100) * 95;
